...
const serviceAccount = require("./hosting-gratis-68a0a-firebase-adminsdk-c2f5h-25cb915b94.json");/*download your own service account key from firebase*/
const client = algoliasearch("WB7ZXYEEB3", "0ce6df1007f7c75d7ebd1e84b306fdee"); /*use your own keys*/
const index = client.initIndex('whatsappy-app');

admin.initializeApp({
  credential: admin.credential.cert(serviceAccount),
  databaseURL: "https://hosting-gratis-68a0a-default-rtdb.firebaseio.com"
});
